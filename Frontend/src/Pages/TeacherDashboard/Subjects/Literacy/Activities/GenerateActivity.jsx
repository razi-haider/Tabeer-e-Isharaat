...
//       const response = await fetch(
//         "http://localhost:4000/api/content/getCategoriesByWeek",
//         {
//           method: "POST",
//           headers: {
...
//       const response = await fetch(
//         "http://localhost:4000/api/words/getWordsByCategory",
//         {
//           method: "POST",
//           headers: {
//             "Content-Type": "application/json",
...
//     const selectedWords = textBox.split(",").filter((word) => word !== "");
...
//   const handleWeekOption = async (option) => {
//     // Get categories based on user's chosen week option
//     const fetchedCategories = await fetchCategoriesByWeek(option);
//     setSecondSelectedOption("Select Category"); // set the default text to category dropdown
...
//     setThirdSelectedOption("Select Words"); // set the default text to words dropdown
...
//                 }}
//               >
//                 <DropDown defaultLabel="Week" options={weeks}></DropDown>{" "}
//               </div>
...
//               <div className="instruction glow">Step 4:</div>
//               <div
//                 style={{
//                   display: "flex",
//                   flexDirection: "column",
...
//                 }}
//               >
//                 <DropDown defaultLabel="Words" options={words}></DropDown>
//               </div>
//             </div>
//             <CustomDatePicker />
//             <div style={{ marginLeft: "700px", width: "100px", marginBottom: "30px"}}>
//               <MultilineTextField />
//             </div>
//           </div>
